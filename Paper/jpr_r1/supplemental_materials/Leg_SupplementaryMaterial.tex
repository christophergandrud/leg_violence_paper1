...
I examined a number of other legislative and societal-level variables to guard against omitted variable bias \add{and test alternative hypotheses}. Results from models with these variables are shown in tables \ref{outputTable.dem} and \ref{outputTable.1990_2nd}. The variables are described below. It is important to first note that overall these factors were not found to be statistically significantly associated with legislative violence nor did they substantively alter the article's core findings.

I avoid focusing on models that include highly correlated variables \citep[]{Achen2002, Schrodt2006}. In these models (not shown), as the statistical literature predicts, the coefficient estimates and standard errors change dramatically for many of the variables. Earlier models included a government system type variable. However, I ignore results from this variable. It had very large, highly unstable, and largely nonsensical coefficient estimates, suggesting that the model does not contain enough information to test \citep{Babyak2004} whether or not crude political system type has an effect on violence. \add{The instability in the coefficient estimates likely has more to do with a lack of variation on this covariate rather than the violence dependent variable. Political systems rarely change in the sample of democracies. Aspects of the political process captured by this variable that are theoretically interesting here--particularly the existence of non-legislative, e.g. presidential veto players, are furthermore captured more directly by other variables included, primarily the political constraints variable from} \cite{Henisz2004}.
...
% Date and time: Tue, Apr 14, 2015 - 09:15:18
...
% Table created by stargazer v.5.1 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Tue, Apr 14, 2015 - 09:15:22
...
% Table created by stargazer v.5.1 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Tue, Apr 14, 2015 - 09:15:28
...
% Table created by stargazer v.5.1 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Tue, Apr 14, 2015 - 09:15:30
...
% Table created by stargazer v.5.1 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Tue, Apr 14, 2015 - 09:15:32
