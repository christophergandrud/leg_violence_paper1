...
It should be noted that the inclusion of governement fractionalisation and single party government variables in the original text did also try to test the ease with which the majority can pass legislation. These variables were always statistically insignificant.
