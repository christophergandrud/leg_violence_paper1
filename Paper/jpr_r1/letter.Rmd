...
Very sorry, this footnote should have been a description of the search terms/data gathering process for the legislative violence data set. This was mistakenly left out of the original submission due to my not noticing a LaTeX compile issue. I have re-entered and expanded the information that should have been included in the main article (pages 12-13) and, in more detail, the Online Appendix (page 1).
