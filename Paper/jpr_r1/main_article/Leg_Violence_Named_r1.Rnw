...
In order to systematically explore the causes of legislative violence across the contemporary globe, I used keyword searches of the Google News Archive LexisNexis, NewsLibrary, NewsBank, general Google Search, and YouTube to create a data set of {\emph{physical fights between legislators in national legislative chambers}}. See the Online Appendix for details. These searches were supplemented by expert information from colleagues resulting in a data set of 131 incidents of legislative violence, 86 of which were in 30 democracies between 1981 and 2012.
