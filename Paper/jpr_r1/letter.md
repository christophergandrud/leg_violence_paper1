...
Second, the large-n empirical results do not provide support for the above interpretation of ethnic fractionalisation (or self-expression). The expectation would be that the societal variables would at least be associated with violence in models without the proportionality/democratic age variables if they were the underlying cause of violence. This is not the case.  
