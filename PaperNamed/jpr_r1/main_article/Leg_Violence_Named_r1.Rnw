...
There are a number of reasons that legislators in new democracies are likely to have credible committment problems.

Legislators in older democracies are more likely to have good information about the likelihood that commitments will actually be adhered to. So, they are more likely to be able to make credible commitments. Legislators in new democracies are limited in the information they can gather to predict if ``pretenders to office can expect to reach it, losers can expect to come back'' \citep[][36]{Przeworski1991}. Actual alternations of power allow legislators to gather better information about the credibility of commitments to allow future alternations of power. Increased information about others' abilities to make credible commitments could strengthen the credibility of future commitments, thus reducing violence.
