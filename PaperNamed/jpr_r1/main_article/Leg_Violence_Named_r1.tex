...
However, there are situations where legislators perceive the benefits of violence to be greater than the costs. Violence in \change{multi-party elected}{democratic} legislatures is often precipitated by situations where legislators find it difficult to credibly commit to follow peaceful bargaining outcomes. In these situations the perceived benefits of violence can outweigh the costs. \add{Violence becomes bargaining by other means.}
\footnote{\add{Some previous work on protests examined how protests' occured more often when protest groups were able to overcome collective action problems.} [CITE] As legislators are typically already highly organized into parties this article does not consider }
\cite{Fearon1995} argued that when actors are not able to make credible commitments the benefits from violent conflict can outweigh the costs making violence more likely \cite[see also][]{Powell2006}. If it is difficult to believe that a peaceful bargaining outcome will actually happen because bargained commitments will likely be broken, actors will choose violence to achieve their goals. This logic is applicable to legislatures. In \change{multi-party elected}{democratic} legislatures winners and losers--who may some day become winners--need to be able to credibly commit to not use or remake legislative procedures in their narrow self-interest. They need to commit to limits on their power \citep{riker1982,Gaubatz1996}, especially legislative rules and procedures that are the result of peaceful bargaining processes. \add{Doing so is critical if current losers are to believe that they will be able to influence policy outcomes in the future when their electoral fortunes improve.} If these credible commitments are not possible then legislators may come to believe that disruption and violence is the best way to achieve their \add{legislative, including policy goals}, despite its costs. What makes legislative credible commitment problems more or less severe?
...
% Date and time: Thu, Apr 02, 2015 - 13:45:55
