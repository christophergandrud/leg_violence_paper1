...
\add{This section presents an illustrative case study of the caning of United States Senator Charles Sumner in 1856. The case study demonstrates the plausibility of the theory that credible commitment problems can lead to legislative violence. It shows that these incidents occur even in Western democracies. The case also illustrates how societal changes can worsen legislative disproportionality, thus increasing violence. Given the relatively shorter time span covered by the large-n data set discussed below and the slowness with which most societal variables change, exploring these complex processes in this well-documented case study is more empirically feasible.}
...
\begin{figure}[h!]
    \centering
        ...
        \caption{Incidences of Physical Fights Between Legislators in \change{Multi-Party Elected}{Democratic} National Legislative Chambers (1981-2012)}
        \label{leg_map}
...
% Date and time: Wed, Apr 01, 2015 - 16:47:45
