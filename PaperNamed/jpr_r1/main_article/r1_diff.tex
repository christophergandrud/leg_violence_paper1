...
%DIF DEL r0.tex                      Tue Apr  7 17:44:03 2015
%DIF ADD Leg_Violence_Named_r1.tex   Wed Apr  8 17:43:05 2015
...
\DIFdelbegin \DIFdel{Unfair }\DIFdelend \DIFaddbegin \DIFadd{Disproportionate }\DIFaddend legislatures have the possibility for large and rapid shifts in legislative power from those who benefit from the status quo rules to those \DIFdelbegin \DIFdel{that }\DIFdelend \DIFaddbegin \DIFadd{who }\DIFaddend would benefit from new rules. For example, if an electoral system that creates disproportionate outcomes becomes more proportional, then the winning parties may be likely to change over the course of one election. The new winners could then further alter legislative procedures \DIFaddbegin \DIFadd{and legislative outcomes }\DIFaddend to benefit themselves through control of the legislative \DIFdelbegin \DIFdel{cartel}\DIFdelend \DIFaddbegin \DIFadd{agenda}\DIFaddend . \cite{Powell2004,Powell2006} identified major commitment problems in bargains over issues affecting future bargaining power when there could be large and rapid power shifts. We can apply his logic to legislatures. Temporarily weak legislators--those with disproportionately fewer seats and access to legislative resources under the status quo--who are not in the legislative cartel need to `buy off' those that are temporarily strong--the beneficiaries of the status quo in the cartel--in order to avoid the strong changing the rules to further benefit themselves. `Buying off' in this context may simply mean agreeing to continue rules that \DIFdelbegin \DIFdel{make the legislature unfair }\DIFdelend \DIFaddbegin \DIFadd{distribute legislative resources away from electoral support }\DIFaddend at the status quo level. However, because the presently weak have the potential to be much stronger, they are likely to renege on agreements that disproportionately benefit the temporarily strong. \DIFdelbegin \DIFdel{They }\DIFdelend \DIFaddbegin \DIFadd{The temporarily strong }\DIFaddend may also have \DIFdelbegin \DIFdel{an incentive }\DIFdelend \DIFaddbegin \DIFadd{incentives }\DIFaddend to use disruption \DIFdelbegin \DIFdel{or }\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend violence to prevent further rule changes that limit their power or \DIFdelbegin \DIFdel{indeed force the rules to become fairer to actively increase their power}\DIFdelend \DIFaddbegin \DIFadd{force rules changes that distribute resources further in their favor}\DIFaddend . Importantly, in the absence of credible commitments from the temporarily weak, the \emph{temporarily strong may use \DIFdelbegin \DIFdel{preemptive }\DIFdelend \DIFaddbegin \DIFadd{pre-emptive }\DIFaddend violence to prevent \DIFaddbegin \DIFadd{changes to }\DIFaddend the rules \DIFdelbegin \DIFdel{from becoming fairer}\DIFdelend \DIFaddbegin \DIFadd{that distribute legislative resources in closer alignment with electoral support}\DIFaddend }.

Why do \DIFdelbegin \DIFdel{very fair legislatures }\DIFdelend \DIFaddbegin \DIFadd{legislatures that have a close correspondence between legislative resources and voter support }\DIFaddend not create equally large credible commitment problems? Presumably legislators that would benefit from \DIFdelbegin \DIFdel{a large increases in unfairness }\DIFdelend \DIFaddbegin \DIFadd{legislative resources being unmoored from voter support }\DIFaddend would find it difficult to credibly commit. In other words, why would a \DIFdelbegin \DIFdel{fair legislature }\DIFdelend \DIFaddbegin \DIFadd{legislature where resources were distributed closely according to electoral support }\DIFaddend create an equilibrium? Rabin's \citeyearpar{Rabin1993} work studying bargaining consequences when actors care about fairness in addition to material well-being provides an answer. Because actors care about \DIFdelbegin \DIFdel{fairness}\DIFdelend \DIFaddbegin \DIFadd{``fairness''}\DIFaddend , they are more likely to maintain commitments (punish defectors), even if it hurts their material well-being, when others are being fair (unfair).
\DIFaddbegin 

\DIFadd{There are many ways to conceptualize fairness, but it's reasonable to assume that a close correspondence between votes and seats will generally be viewed as more fair. }\DIFaddend One form of \DIFdelbegin \DIFdel{punishment could be reputational damage inflicted in fair systems by both supporters and opponents of violent legislators who care about fairness}\DIFdelend \DIFaddbegin \DIFadd{``punishment'' that could be inflicted on those who break fair--highly proportional--bargains is reputational damage}\DIFaddend . This reduces legislators' incentives to defect from fair \DIFdelbegin \DIFdel{rules and }\DIFdelend bargains even if they could gain legislative power by increasing \DIFdelbegin \DIFdel{unfairness}\DIFdelend \DIFaddbegin \DIFadd{disproportionality}\DIFaddend . As such credible commitment problems are lower and actors can reach a ``fairness equilibrium'' \DIFaddbegin \DIFadd{in highly proportional systems}\DIFaddend . Experimental research supports the idea that commitments are more credible if they are fairer \citep{Ellingsen2004} and can even act as an enforcement device for incomplete contracts \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
...
%DIFDELCMD < %%%
\DIFdel{Possibly the most important and clearly observable component of legislature fairness is the proportionality of the election that allocated its seats and therefore the control of its procedures. Disproportional, i.e. unfair, electoral outcomes create credible commitment problems as they create the potential for shifts in power from beneficiaries of unfair to fair rules. More proportional systems conversely enable fairness equilibria. At what observable }\DIFdelend \DIFaddbegin \DIFadd{At what }\DIFaddend levels of disproportionately would we expect to \DIFdelbegin \DIFdel{see }\DIFdelend \DIFaddbegin \DIFadd{observe }\DIFaddend more violence? At most levels of disproportionately there may be credible commitment problems to some degree, because there will be legislators who benefit from an increase in proportionality. It is only when outcomes are close to perfectly proportional that the gains from increasing proportionality are very small or virtually none existent. At the same time in systems with very proportional electoral outcomes it is \DIFdelbegin \DIFdel{easy for all to }\DIFdelend \DIFaddbegin \DIFadd{more likely that all sides }\DIFaddend identify the electoral outcomes as fair, thus enabling fairness equilibria.\footnote{When there is ambiguity over how fair the system is actors may not impose very high costs \DIFdelbegin \DIFdel{, such as reputational damage, }\DIFdelend for breaking the rules.} Because of this we should not expect a linear relationship between disproportionately and violence. There should instead be a threshold effect where very proportional electoral outcomes will have very low levels of violence due to very small or non-existent credible commitment problems.
...
}\DIFaddend , possibly as politicians work out electoral coordination problems \citep{cox1997}. New democracies may \DIFdelbegin \DIFdel{also }\DIFdelend have rapidly changing economies and demographics that \DIFdelbegin \DIFdel{further change }\DIFdelend \DIFaddbegin \DIFadd{additionally alter }\DIFaddend the party system and \DIFdelbegin \DIFdel{the proportionality of legislative rules}\DIFdelend \DIFaddbegin \DIFadd{legislative proportionality}\DIFaddend . Even if rules \DIFdelbegin \DIFdel{were fair }\DIFdelend \DIFaddbegin \DIFadd{proportionally distributed resources }\DIFaddend when they were created, they may quickly become less \DIFdelbegin \DIFdel{so }\DIFdelend \DIFaddbegin \DIFadd{proportional }\DIFaddend as the country changes. On average, these shifts could be much larger in new as opposed to old democracies. As we will see in the antebellum US case below, \DIFdelbegin \DIFdel{large rapid }\DIFdelend demographic and party system shifts dramatically altered the \DIFdelbegin \DIFdel{fairness }\DIFdelend \DIFaddbegin \DIFadd{proportionality }\DIFaddend of the distribution of power in the US Senate\DIFdelbegin \DIFdel{between pro and anti-slavery senators around the 1840s and 1850s}\DIFdelend . Because of the instability of new party systems, there is a greater likelihood that legislatures could become \DIFdelbegin \DIFdel{unfair }\DIFdelend \DIFaddbegin \DIFadd{disproportional }\DIFaddend leading to credible commitment problems and violence.
...
in that the United States at the time was a new democracy and the US Senate was very disproportional. So, it is useful for illustrating and probing our causal mechanisms in detail. Second, the Senate's disproportionality increased over time due to reasons that are largely exogenous of the legislature. This allows us to make a within-case comparison, such that we can explore the causal direction of the relationship between violence and disproportionality. Third, the case is drawn from outside the large-n sample discussed below. This helps us initially explore whether the hypotheses proposed in this article are generalizable to other time periods. Finally, the case also illustrates how societal changes can worsen legislative disproportionality, thus increasing violence. Given the relatively shorter time span covered by the large-n data set discussed below and the slowness with which most societal variables change, exploring these complex processes in this well-documented case study is more empirically feasible.
}

\DIFaddend The breakdown of the ability to make credible commitments in \DIFdelbegin \DIFdel{unfair }\DIFdelend \DIFaddbegin \DIFadd{disproportionate }\DIFaddend and new democratic legislatures is a key component behind the caning\DIFdelbegin \DIFdel{of United States Senator Charles Sumner in 1856. }\DIFdelend \DIFaddbegin \DIFadd{. }\DIFaddend The development of the Senate prior to the Civil War, and especially in the 1850s, was preoccupied with the apportionment of pro and anti-slavery senators and how this apportionment was becoming increasingly unfair. Two senators were elected by each state's legislature. From the end of the Revolutionary War there had been more slave states than free states, thus more slave state senators and a pro-slave Senate veto \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
...
. Expected }\DIFaddend probabilities for various fitted values of the key findings of interest \DIFdelbegin \DIFdel{with robust results }\DIFdelend are shown in Figure \ref{pred_prob}. These give us a substantively meaningful sense of estimated effects' magnitudes. Note: because the variables are in country-year records, all of the results should be interpreted in terms of the predicted effect of a variable on the probability of legislative violence in a given country \DIFdelbegin \DIFdel{in a }\DIFdelend \DIFaddbegin \DIFadd{per }\DIFaddend year.

I observed relatively few incidences of violence in the 1980s.\footnote{There were only 8 observed incidence before \DIFdelbegin \DIFdel{1990.}%DIFDELCMD < } %%%
\DIFdel{This may be because news articles from before the 1990s have not been made available on the internet with the same frequency as those written from the 1990s}\DIFdelend \DIFaddbegin \DIFadd{1990 in the full sample}\DIFaddend .\DIFaddbegin } \DIFaddend To examine any estimation biases this sampling bias might create I ran the regressions on a further constricted sample of \DIFdelbegin \DIFdel{multi-party elected }\DIFdelend \DIFaddbegin \DIFadd{democratic }\DIFaddend legislatures from 1990. The results were broadly similar across the two samples. Regression coefficient point estimates and robust standard errors for the sample that is truncated from 1990 can be found in Table \ref{outputTable.1990}. Results from the full observation period can be found in the \DIFdelbegin \DIFdel{Supplementary Material. }\DIFdelend \DIFaddbegin \DIFadd{Online Appendix. In addition, the Online Appendix contains an examination of why more incidents are observed in more recent time periods.
}\DIFaddend 
...
Across \DIFaddbegin \DIFadd{virtually }\DIFaddend all of the models the estimates for the dummy {\emph{low disproportionality}} variable indicate that proportional electoral outcomes are associated with less legislative violence. This finding is robust at least at the 5\% significance level in \DIFdelbegin \DIFdel{all }\DIFdelend \DIFaddbegin \DIFadd{most }\DIFaddend model specifications.\DIFaddbegin \footnote{\DIFadd{The only model in Table \ref{outputTable.1990} where it just drops below the 10\% significance level is Model 6. This model includes the self expression variable which, due list-wise deletion for missingness, causes the sample size to be cut almost in half. In the full 1990-2012 sample the coefficient estimate was significant at the 10\% level with self-expression included. Please see the Online Appendix.}} \DIFaddend The finding corroborates what we saw in the Sumner caning case study and Figure \ref{framework_empirical}. \DIFdelbegin \DIFdel{Violence is rare in countries with Gallagher scores below the median--6--and there is something of a cut-off point--around 2.5--below which these highly proportional countries were almost never observed to have had violence. }\DIFdelend More interesting than simple statistical significance or coefficient point estimates is the magnitude of and uncertainty surrounding the disproportionality/violence relationship. To get a sense of the magnitude of this estimated relationship and the uncertainty around it I plotted the predicted probabilities of having a legislative brawl in the left-most plot of Figure \ref{pred_prob} using estimates from Model \DIFdelbegin \DIFdel{A2. }\DIFdelend \DIFaddbegin \DIFadd{4. }\DIFaddend We can see that the \DIFdelbegin \DIFdel{central tendency of the predicted }\DIFdelend \DIFaddbegin \DIFadd{median of the expected }\DIFaddend probabilities of a country having violence when disproportionality is greater than or equal to \DIFdelbegin \DIFdel{6 is over two }\DIFdelend \DIFaddbegin \DIFadd{6.34 is well over three }\DIFaddend percent in a given year. All other variables are fitted at their means. Countries with disproportionality less than \DIFdelbegin \DIFdel{6 had a very low predicted probability of violence in a year}\DIFdelend \DIFaddbegin \DIFadd{6.34 a median expected probability closer to one percent}\DIFaddend .

\paragraph{Age of \DIFdelbegin \DIFdel{Democracy}\DIFdelend \DIFaddbegin \DIFadd{democracy}\DIFaddend }

Also, corroborating the evidence we saw before, the analyses indicate that older democracies tend to have less legislative violence. This result is significant at least at the \DIFdelbegin \DIFdel{10 percent }\DIFdelend \DIFaddbegin \DIFadd{5\% }\DIFaddend level in all of the models. Looking at the middle panel of Figure \ref{pred_prob} we can see that violence is more likely in younger democracies. Very young democracies are predicted to have \DIFdelbegin \DIFdel{about a three to four }\DIFdelend \DIFaddbegin \DIFadd{a greater than five }\DIFaddend percent probability of experiencing legislative violence in a given year. The probability of violence decreases steadily as a democracy ages.
...
In this \DIFdelbegin \DIFdel{paper--the }\DIFdelend \DIFaddbegin \DIFadd{article--the }\DIFaddend first to systematically examine legislative violence in \DIFdelbegin \DIFdel{multi-party elected }\DIFdelend \DIFaddbegin \DIFadd{democratic }\DIFaddend legislative chambers on a global scale--I developed an argument that violence in these chambers is more likely when legislators are unable to make credible commitments to peaceful bargaining outcomes\DIFdelbegin \DIFdel{, including non-violent legislative rules. This problem is greatly exacerbated by a lack of legislative fairness. }\DIFdelend \DIFaddbegin \DIFadd{. }\DIFaddend I then empirically tested my argument with a case study of the caning of Senator Sumner in the antebellum United States and a new data set of recent legislative brawls. What conclusions can we make from the \DIFdelbegin \DIFdel{paper}\DIFdelend \DIFaddbegin \DIFadd{article}\DIFaddend 's findings about why legislators are kept `two sword lengths' apart (or not) and what implications do they have?

The findings in this \DIFdelbegin \DIFdel{paper }\DIFdelend \DIFaddbegin \DIFadd{article }\DIFaddend suggest that countries with highly \DIFdelbegin \DIFdel{proportional--very fair--electoral }\DIFdelend \DIFaddbegin \DIFadd{proportional electoral }\DIFaddend outcomes rarely experience legislative violence. Looking broadly at the recent global sample the relationship appears to be subject to a threshold effect where countries with Gallagher Index scores below about \DIFdelbegin \DIFdel{6 }\DIFdelend \DIFaddbegin \DIFadd{6.34 }\DIFaddend rarely experience legislative violence and there \DIFdelbegin \DIFdel{was only one observed incident }\DIFdelend \DIFaddbegin \DIFadd{were only two observed incidents }\DIFaddend when the Index was below 2.5. This corresponds closely to the idea of fairness equilibrium and previous findings made by Marien \citeyearpar{Marien2011} about perceptions of political trust in countries with highly proportional outcomes using the same measure.
...
. This article aimed to find and highlight the institutional factors that could help move such legislatures closer to the democratic ideal.
}

\DIFaddend As this is the first large scale study on this subject there is still considerable work that can be done to better understand the causes and consequences of legislative violence. As mentioned earlier more work is needed on legislator-level cultural values and the effects of very large majority governments. \DIFaddbegin \DIFadd{Research could explore how societal changes, such as demographic and party system movement affect factors such as disproportionately, leading to violence. }\DIFaddend Further case study work could examine non-electoral fairness issues that could exacerbate credible commitment problems. In particular, more research could be done on post-election solutions that make the distribution of legislative resources fairer \cite[for example see][who examined informal minority party access to power in Japan's Diet]{Wolfe2004}. \DIFdelbegin \DIFdel{Non-fairness}\DIFdelend \DIFaddbegin \DIFadd{Non-disproportionality}\DIFaddend /shifts in power causes of credible commitment problems should also be explored. Another avenue worth pursuing would be to empirically examine how credible commitment problems change the likelihood of less severe forms of legislative disruption, such as boycotts and shouting. Finally, what are the consequences of legislative violence, especially for citizens' perceptions of democratic legitimacy and, indeed, the long-term viability of democratic regimes?
...
% Date and time: Wed, Apr 08, 2015 - 17:43:03
