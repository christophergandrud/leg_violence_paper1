...
<<OutTable1, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    CoefNames <- c("Low Disproportionality",
                    "Dem. Age", "Majority Size", "Internal Armed Conflict",
    ...
    stargazer(D1, D2, D3, D4, D5, D6, D7, D8, D9, D10,
...
<<OutTable2, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    stargazer(DN6, DN7, DN8, DN9, DN10, DN11,
    dep.var.labels = 'Violent Incident',
    covariate.labels = CoefNames,
    float = F,
    out.header = F,
...
\begin{center}
\scalebox{0.6}{
<<OutTable3, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    library(stargazer)

    CoefNames <- c("Proportional Electoral System",
                    "Dem. Age", "Majority Size", "Internal Armed Conflict",
                    "Self Expression", "Ethnic Frac.", "Perc. Women in Parl.",
                    "Murder Rate", "Federal", "Gov. Frac.",
                    "No. of Parties by Seats", "GINI", "GDP per Capita (log)",
    ...
    stargazer(DNP1, DNP2, DNP3, DNP4, DNP5, DNP6, DNP7, DNP8, DNP9, DNP10,
    dep.var.labels = 'Violent Incident',
    covariate.labels = CoefNames,
    float = F,
    out.header = F,
