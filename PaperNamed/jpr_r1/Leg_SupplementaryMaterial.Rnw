...
<<models, include=FALSE>>=
    source("/git_repositories/leg_violence_paper1/Analysis/leg_main_analyses_v4.R")
@
...
<<compareLegToViolence, warning=FALSE, echo=FALSE, message=FALSE, fig.width=7, fig.height=7, out.width='0.8\\linewidth'>>=
    source("/git_repositories/leg_violence_paper1/Analysis/dem_vs_incidents.R")
@
    \end{center}
...
<<OutTable1, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    CoefNames <- c("Lower Disproportionality",
                    ...
                    "Self Expression", "Ethnic Frac.", "Perc. Women in Parl.",
                    "Murder Rate", "Federal", "Gov. Frac.",
                    "No. of Parties by Seats", "GINI", "GDP per Capita (log)",
                   "(Intercept)")

    stargazer(D1, D2, D3, D4, D5, D6, D7, D8, D9, D10, D11,
...
<<OutTable2, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    CoefNames <- c("Lower Disproportionality",
                "Dem. Age (log)", "Majority Size", "Internal Armed Conflict",
                "Perc. Women in Parliament",
                "Murder Rate", "Federal", "Gov. Frac.",
                "No. of Parties by Seats", "Gini", "GDP per Capita (log)",
                "(Intercept)")

    stargazer(DN8, DN9, DN10, DN11, DN12, DN13,
    dep.var.labels = 'Violent Incident',
    covariate.labels = CoefNames,
    float = F,
    out.header = F,
...
<<predProInteract1, warning=FALSE, echo=FALSE, message=FALSE, results='hide', fig.width=7, fig.height=7, out.width='0.95\\linewidth', cache=FALSE>>=
    ## Estimate models
    source('/git_repositories/leg_violence_paper1/Analysis/leg_interactions.R')

    ## Create Graphs ##
    source("/git_repositories/leg_violence_paper1/Analysis/expected_values_interactions.R")
...
\begin{figure}
    \begin{center}
<<marginalEffects, warning=FALSE, echo=FALSE, message=FALSE, results='hide', fig.width=6, fig.height=6, out.width='0.95\\linewidth', cache=FALSE>>=
    ## Create Graphs ##
    source('/git_repositories/leg_violence_paper1/Analysis/interaction_marginal_effects.R')
@
    \end{center}
