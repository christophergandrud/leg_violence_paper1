...
- Second, the large-n empirical results do not provide support the above interpretation. As mentioned in the paper ([GET PAGE]), the expectation would be that the societal variables would at least be associated with violence in models without the proportionality/democratic age variables if they were the underlying cause of violence. This is not the case.  
...
All of this does not mean that societal factors could not be part of a a more complicated causal story, but it does indicate that proporationality and democratic age are not simply proxies for societal divisions.
