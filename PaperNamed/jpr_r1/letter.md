...
# Joint concerns of Reviewers 2 and 3
...
Overall, the theoretical focus of this paper is on the control of legislative resources, broadly defined. As such it largely encompassing *both* control of policy *and* control of legislative procudures/rule-making. This is reasonable as the set of actors that control legislative procedures and control legislative policy outcomes--bills that pass the legislature--is very similar. Who controls the procedures often controls the policy outcomes. And policy outcomes can affect who controls the procedures in the future. To clarify this point I have altered the wording in the paper [TO-DO] to show that credible commitment problems are typically related to both.

Based on the prevailing understanding in legislative studies--in particular Cox's  'legislative cartel'--it is reasonable to assume that control of legislative procedures and legislative policy outcomes are highly intertwined such that who controls the legislative procedures controls what bills pass the legislature. Cox showed, for example, how important control of the legislative session's agenda was to affecting what bills pass. As such legislators, even those primarily concerned with policy outcomes, will be highly influenced in their behaviour by credible commitments about legislative rules and use of legislative resources.
...
That being said, control over what passes in the legislature is not necessarily the same thing as who controls policy outcomes, especially if there are external veto players (e.g. presidents or judiciaries). Perhaps, the wider political institutions that control government policy, rather than just legislative outcomes impacts decisions to brawl. To operationalise how difficult it is to change policy I included Henisz's widely used measure of political constraints, which explicitly captures the feasibility of policy change. In purely additive models it is not statistically significant, i.e. I did not find evidence that there is an addittive relationship between political constraints and legislative brawls. In a new Interactions section in the Online Appendix (page [GET]) I discuss some evidence that perhaps there is an interaction between political constraints and democratic age, such that more political constraints could help overcome credible commitment problems in new democracies. Current losers may be less worried that the current winners can change the rules/implement policies that shift or entrench power in their favour.
