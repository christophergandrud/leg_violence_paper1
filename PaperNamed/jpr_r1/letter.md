...
- I realise that unfortunately the footnote detailing the original data gathering process was accidentally not included in the original version. I have made sure that this information is now available in an expanded section in the Supplemental Materials. In addition, I and three new research assistants have verified and updated the data set using additional LexisNexis, NewsLibrary, NewsBank, NewsBank, Google, and YouTube (a surprisingly good source of information on legislative brawls) keyword searches. I have added a description of this process to the Supplemental Materials

- Regarding multiple events involving the same actors: by viewing YouTube video footage of many of the brawls, it is clear that each brawl can be considered a single event. Though brawl intensity varies over the course of the brawl as more or fewer legislators are involved, they tend to center around the same issue on the same day. Therefore I treat each brawl as a single event per day. I added a footnote on this to. A discussion is on page 1 of the Supplemental Materials.
