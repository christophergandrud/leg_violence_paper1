...
\hline
(Intercept)             & $-1.48^{**}$  & $-2.56^{***}$ & $-4.58$      & $-1.83^{***}$ & $-2.38^{***}$ & $-1.91^{***}$ & $-1.57^{**}$ & $-1.82^{***}$ \\
                        & $(0.45)$      & $(0.65)$      & $(2.86)$     & $(0.53)$      & $(0.68)$      & $(0.48)$      & $(0.63)$     & $(0.50)$      \\
Low Disproportionality  & $-0.47^{*}$   & $-0.71^{**}$  & $-0.39$      & $-0.54^{*}$   & $-0.44$       & $-0.56^{**}$  & $-0.54^{**}$ & $-0.40$       \\
                        & $(0.25)$      & $(0.26)$      & $(0.28)$     & $(0.30)$      & $(0.35)$      & $(0.26)$      & $(0.26)$     & $(0.27)$      \\
Dem. Age                & $-0.01^{**}$  & $-0.01^{**}$  & $-0.02^{**}$ & $-0.01^{*}$   & $-0.01^{*}$   & $-0.02^{**}$  & $-0.02^{**}$ & $-0.02^{**}$  \\
                        & $(0.00)$      & $(0.01)$      & $(0.01)$     & $(0.01)$      & $(0.01)$      & $(0.01)$      & $(0.01)$     & $(0.01)$      \\
Majority Size           & $-0.03^{***}$ & $-0.03^{***}$ & $-0.03^{**}$ & $-0.03^{**}$  & $-0.01$       & $-0.03^{**}$  & $-0.03^{**}$ & $-0.03^{**}$  \\
                        & $(0.01)$      & $(0.01)$      & $(0.01)$     & $(0.01)$      & $(0.01)$      & $(0.01)$      & $(0.01)$     & $(0.01)$      \\
Leg. Immunity           &               & $-0.27$       &              &               &               &               &              &               \\
                        &               & $(0.26)$      &              &               &               &               &              &               \\
PR Electoral System     &               & $1.35^{**}$   &              &               &               &               &              &               \\
                        &               & $(0.46)$      &              &               &               &               &              &               \\
Single Party Gov.       &               & $-0.24$       &              &               &               &               &              &               \\
                        &               & $(0.25)$      &              &               &               &               &              &               \\
Self Expression         &               &               & $2.68$       &               &               &               &              &               \\
                        &               &               & $(2.27)$     &               &               &               &              &               \\
Ethnic Frac.            &               &               & $-0.80$      &               &               &               &              &               \\
                        &               &               & $(0.72)$     &               &               &               &              &               \\
Perc. Women in Parl.    &               &               &              & $-0.00$       &               &               &              &               \\
                        &               &               &              & $(0.02)$      &               &               &              &               \\
Murder Rate             &               &               &              &               & $-0.00$       &               &              &               \\
                        &               &               &              &               & $(0.01)$      &               &              &               \\
Federal                 &               &               &              &               &               & $0.60^{*}$    & $0.67^{*}$   &               \\
...
Gov. Frac.              &               &               &              &               &               & $0.16$        &              &               \\
                        &               &               &              &               &               & $(0.45)$      &              &               \\
No. of Parties by Seats &               &               &              &               &               &               & $-0.06$      &               \\
                        &               &               &              &               &               &               & $(0.08)$     &               \\
GDP per Capita          &               &               &              &               &               &               &              & $0.02$        \\
                        &               &               &              &               &               &               &              & $(0.02)$      \\
\hline
AIC                     & 572.81        & 551.68        & 414.14       & 462.35        & 308.84        & 524.21        & 523.84       & 471.67        \\
BIC                     & 594.42        & 589.18        & 442.71       & 488.90        & 333.32        & 555.71        & 555.36       & 497.76        \\
Log Likelihood          & -282.40       & -268.84       & -201.07      & -226.18       & -149.42       & -256.10       & -255.92      & -230.83       \\
Deviance                & 564.81        & 537.68        & 402.14       & 452.35        & 298.84        & 512.21        & 511.84       & 461.67        \\
Num. obs.               & 1643          & 1568          & 864          & 1494          & 1041          & 1408          & 1412         & 1412          \\
\hline
\multicolumn{9}{l}{\scriptsize{$^{***}p<0.001$, $^{**}p<0.05$, $^*p<0.1$}}
\end{tabular}
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=0.9\linewidth]{figure/predProb-1} 

\end{knitrout}
    \end{center}
    \begin{singlespace}
      {\scriptsize{The graphs show the median and middle 95\% of 1000 simulations at each fitted value of the variables. The simulations use Model A2, Table \ref{outputTable.1990}. For each set of simulations all other variables were fitted at their means.}}
    \end{singlespace}
\end{figure}
