...
% Date and time: Wed, Mar 25, 2015 - 11:32:31
...
\\[-1.8ex] & (1) & (2) & (3) & (4) & (5) & (6) & (7)\\ 
\hline \\[-1.8ex] 
 Lower Disproportionality & $-$0.529$^{**}$ & $-$0.602$^{**}$ & $-$0.602$^{**}$ & $-$0.602$^{**}$ & $-$0.581$^{**}$ & $-$0.480 & $-$0.590$^{**}$ \\ 
  & (0.267) & (0.268) & (0.269) & (0.270) & (0.269) & (0.296) & (0.269) \\ 
  & & & & & & & \\ 
 Dem. Age (log) & $-$0.282$^{**}$ & $-$0.289$^{**}$ & $-$0.288$^{**}$ & $-$0.295$^{***}$ & $-$0.287$^{**}$ & $-$0.354$^{***}$ & $-$0.300$^{***}$ \\ 
  & (0.111) & (0.113) & (0.112) & (0.113) & (0.112) & (0.135) & (0.114) \\ 
  & & & & & & & \\ 
 Majority Size &  & $-$0.027$^{***}$ & $-$0.027$^{***}$ & $-$0.027$^{***}$ & $-$0.025$^{***}$ & $-$0.026$^{***}$ & $-$0.027$^{***}$ \\ 
  &  & (0.009) & (0.009) & (0.009) & (0.009) & (0.010) & (0.009) \\ 
  & & & & & & & \\ 
 Internal Armed Conflict &  &  & 0.535 & 0.493 & 0.510 & 0.497 & 0.544 \\ 
...
Across all of the models the estimates for the dummy {\emph{low disproportionality}} variable indicate that proportional electoral outcomes are associated with less legislative violence. This finding is robust at least at the 5\% significance level in \change{all}{most} model specifications.\footnote{\add{The one exception is Model 5 which, due to list-wise deletion for missing information on the self expression variable, has about half the number of observations as the other models.}} The finding corroborates what we saw in the Sumner caning case study and Figure \ref{framework_empirical}. Violence is rare in countries with Gallagher scores below the median--6.4--and there is something of a cut-off point--around 2.5--below which these highly proportional countries were almost never observed to have had violence. More interesting than simple statistical significance or coefficient point estimates is the magnitude of and uncertainty surrounding the disproportionality/violence relationship. To get a sense of the magnitude of this estimated relationship and the uncertainty around it I plotted the predicted probabilities of having a legislative brawl in the left-most plot of Figure \ref{pred_prob} using estimates from Model 4. We can see that the median of the expected probabilities of a country having violence when disproportionality is greater than or equal to \change{6}{6.4} is \add{well} over \change{two}{three} percent in a given year. All other variables are fitted at their means. Countries with disproportionality less than \change{6}{6.4} had a very low predicted probability of violence in a year.
...
\add{
Internal armed conflict is positively and statistically associated with legislative violence. There are a number of possible reasons for this. First, the inability to make credible legislative bargains could spill over into actual armed fights. For example, the Ukrainian parliament's in ability to peacefully bargain in the legislature over divisive issues such as Russian military bases and linguistic divisions was followed by actual armed conflict in Crimea and Southern regions of the country. Second, internal violent conflict could heightened the costs and benefits of legislative power. For example, it could determine what strategy is used in the conflict or how resources are allocated. Decisions over such immediate partisan life and death matters could make legislative violence a more attractive

These are not mutually exclusive. Future research, when a longer time-series is available, should examine how legislative violence could be both a cause of and caused by internal armed conflict. It is important to note that the inclusion of armed conflict largely does not affect the magnitude of the key estimate effects. The effect of internal armed conflict appears to be in addition to the political institutional factors.
}
